...
// Enable every family exposed by this pinned OpenMV / AprilTag version.
// Family dictionaries reside in the external firmware image, not the 1 MiB
// internal MRAM. Keep platform/SConscript's family source list in sync.
...
// Enable both corner detectors supported by find_keypoints().
...
// Software stereo on a supplied side-by-side grayscale image. Capturing a
// synchronized stereo pair still requires suitable external camera hardware.
