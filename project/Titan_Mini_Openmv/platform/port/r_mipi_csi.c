/* Project-maintained FSP adapter: use receiver activity status when stopping CSI. */
/*
...
fsp_err_t R_MIPI_CSI_Stop (mipi_csi_ctrl_t * const p_api_ctrl)
{
     ...
     *----------------------------------------------------------------------------------------------------*/
    FSP_ERROR_RETURN(!R_MIPI_CSI->RXST_b.RACT, FSP_ERR_IN_USE); // RXSC is write-only.
