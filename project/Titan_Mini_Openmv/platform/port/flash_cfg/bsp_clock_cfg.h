...
/* Project-maintained Flash clock configuration. */
...
#define BSP_CFG_BCLKA_DIV (BSP_CLOCKS_BCLKA_CLOCK_DIV_8) /* BCLKA Div /8 */
...
#define BSP_CFG_OCTACLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_MAIN_OSC) /* Flash: 24 MHz XTAL */
#define BSP_CFG_OCTACLK_DIV (BSP_CLOCKS_OCTA_CLOCK_DIV_1) /* Flash: divide by 1 */
