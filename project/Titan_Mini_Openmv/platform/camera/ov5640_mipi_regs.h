 ...
 * Register sequence from the Titan Mini MIPI CSI camera example.
 * Sensor transmits 2-lane CSI-2 YUYV; VIN performs RGB565 conversion.
 */
#define REQUEST_SOFTWARE_WAIT 0xaaaa
#define CONFIG_TABLE_END_DETECT 0xffff
#define X_ADDR_START 32
#define Y_ADDR_START 22
#define X_ADDR_END 2592
#define Y_ADDR_END 1942
#define X_OFFSET 16
#define Y_OFFSET 16
#define CAMERA_ACTIVE_IMAGE_WIDTH 640
#define CAMERA_ACTIVE_IMAGE_HEIGHT 480
#define REG_VALUE_5580 0x04
#define REG_VALUE_5585 0x00
#define REG_VALUE_5586 0x20
#define REG_VALUE_5587 0x00
#define REG_VALUE_5588 0x01
#define REG_VALUE_501D 0x40
static const titan_sensor_reg_t titan_ov5640_mipi_regs[] =
{
 { 0x3103, 0x11 },
 { 0x3008, 0x82 },

 { REQUEST_SOFTWARE_WAIT, 0xFF },
 ...
 { 0x3800, ((X_ADDR_START >> 8) & 0xFF) },
 { 0x3801, (X_ADDR_START & 0xFF) },
 { 0x3802, ((Y_ADDR_START >> 8) & 0xFF) },
 { 0x3803, (Y_ADDR_START & 0xFF) },
 { 0x3804, ((X_ADDR_END >> 8) & 0xFF) },
 { 0x3805, (X_ADDR_END & 0xFF) },
 { 0x3806, ((Y_ADDR_END >> 8) & 0xFF) },
 { 0x3807, (Y_ADDR_END & 0xFF) },

 { 0x3810, ((X_OFFSET >> 8) & 0xFF) },
 { 0x3811, (X_OFFSET & 0xFF) },
 { 0x3812, ((Y_OFFSET >> 8) & 0xFF) },
 { 0x3813, (Y_OFFSET & 0xFF) },

 { 0x3808, ((CAMERA_ACTIVE_IMAGE_WIDTH >> 8) & 0xFF) },
 { 0x3809, (CAMERA_ACTIVE_IMAGE_WIDTH & 0xFF) },
 { 0x380a, ((CAMERA_ACTIVE_IMAGE_HEIGHT >> 8) & 0xFF) },
 { 0x380b, (CAMERA_ACTIVE_IMAGE_HEIGHT & 0xFF) },
 ...
 { 0x5300, 0x08 }, { 0x5301, 0x30 }, { 0x5302, 0x5f }, { 0x5303, 0x10 },
 { 0x5304, 0x08 }, { 0x5305, 0x30 }, { 0x5306, 0x28 }, { 0x5307, 0x38 },
