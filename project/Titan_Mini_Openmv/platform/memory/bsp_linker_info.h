...
#define BSP_PARTITION_RAM_CPU0_S_SIZE (0x1D4000)
#define BSP_PARTITION_SHARED_MEM_START (0x22174000)
#define BSP_PARTITION_SHARED_MEM_SIZE (0x0)
...
#define BSP_PARTITION_RAM_CPU1_S_SIZE (0x0)
...
#define BSP_PARTITION_FLASH_CPU1_S_SIZE (0x0)
