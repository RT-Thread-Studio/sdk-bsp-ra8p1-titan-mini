...
#define BSP_OPENMV_STORAGE_SD
#define OPENMV_HEAP_SIZE 1376256
#define OPENMV_JPEG_BUF_SIZE 32768

/* OpenMV + Ethos-U55, 1344 KiB SRAM GC */

/* Required DFS v1 / FAT / POSIX and local TinyUSB are selected */

#define PKG_USING_TINYUSB
#define PKG_TINYUSB_STACK_SIZE 4096
...
#define PKG_TINYUSB_DEVICE_VID 0x37C5
#define PKG_TINYUSB_DEVICE_PID 0x16E3
#define PKG_TINYUSB_DEVICE_MANUFACTURER "OpenMV"
#define PKG_TINYUSB_DEVICE_PRODUCT "OpenMV AE3"
...
#define PKG_TINYUSB_DEVICE_CDC_RX_BUFSIZE 2048
#define PKG_TINYUSB_DEVICE_CDC_TX_BUFSIZE 2048
/* end of Titan Mini OpenMV port */
