# Source: ThirdParty/openmv/scripts/examples/03-Machine-Learning/02-Haar-Cascade/face_recognition.py
# Titan Mini: Requires the AT&T orl_faces dataset in the storage root.
