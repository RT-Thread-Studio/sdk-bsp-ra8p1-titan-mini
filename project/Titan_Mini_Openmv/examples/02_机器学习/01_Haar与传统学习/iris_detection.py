# Source: ThirdParty/openmv/scripts/examples/03-Machine-Learning/02-Haar-Cascade/iris_detection.py
# Titan Mini: Official example; requires /rom/haarcascade_eye.cascade.
