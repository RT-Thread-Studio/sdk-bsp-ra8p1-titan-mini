# Titan Mini RA8P1: MoveNet 人体 17 关键点
# Source: examples/movenet_pose.py
# Prerequisites and exact copy paths: ../README.md.
# Copy models/sdcard/movenet_singlepose_192_u55_256.tflite -> /movenet_singlepose_192_u55_256.tflite
...
# Load the pose detection model from the selected storage filesystem.
model = ml.Model("/rom/movenet_singlepose_192_u55_256.tflite", postprocess=MoveNet(threshold=0.4))
print(model)
