# Titan Mini RA8P1: BlazeFace 人脸与六关键点
# Source: ThirdParty/openmv/scripts/examples/03-Machine-Learning/00-TensorFlow/blazeface_detector.py
...
model = ml.Model("/rom/blazeface_front_128_u55_256.tflite", postprocess=BlazeFace(threshold=0.4))
print(model)
