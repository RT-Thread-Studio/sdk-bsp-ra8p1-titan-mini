...
# Copy models/sdcard/yolov8n_192_u55_256_cpu_softmax.tflite -> /yolov8n_192_u55_256_cpu_softmax.tflite
# Copy models/sdcard/yolov8n_192_u55_256_cpu_softmax.txt -> /yolov8n_192_u55_256_cpu_softmax.txt
...
model = ml.Model("/rom/yolov8n_192_u55_256_cpu_softmax.tflite", postprocess=YoloV8(threshold=0.4))
print(model)
