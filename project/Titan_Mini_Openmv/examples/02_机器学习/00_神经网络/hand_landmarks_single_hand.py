...
# Titan Mini: copy these files from models/sdcard/ to the storage root without renaming:
# palm_detection_full_192_u55_256.tflite and hand_landmarks_full_224_u55_256.tflite.
