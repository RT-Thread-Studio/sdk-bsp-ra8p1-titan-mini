# Titan Mini RA8P1: BlazePalm 手掌检测
# Source: ThirdParty/openmv/scripts/examples/03-Machine-Learning/00-TensorFlow/blazepalm_detection.py
...
model = ml.Model("/rom/palm_detection_full_192_u55_256.tflite", postprocess=BlazePalm(threshold=0.4))
print(model)
