# Titan Mini RA8P1: ResNet8 CIFAR10 分类
# Source: examples/public_classification.py
# Prerequisites and exact copy paths: ../README.md.
# Copy models/sdcard/resnet8_u55_256.tflite -> /resnet8_u55_256.tflite
# Copy models/sdcard/resnet8_u55_256.txt -> /resnet8_u55_256.txt
...
while True:
    ...
    img.draw_string((0, 0), "%s %.3f" % (model.labels[best], scores[best]), color=(0, 255, 0))
