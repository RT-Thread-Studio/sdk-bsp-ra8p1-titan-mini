# Titan Mini RA8P1: FOMO 人脸中心检测
# Source: ThirdParty/openmv/scripts/examples/03-Machine-Learning/00-TensorFlow/tf_object_detection.py
# Prerequisites and exact copy paths: ../README.md.
# Copy models/sdcard/fomo_face_detection_u55_256.tflite -> /fomo_face_detection_u55_256.tflite
# Copy models/sdcard/fomo_face_detection_u55_256.txt -> /fomo_face_detection_u55_256.txt
...
model = ml.Model("/rom/fomo_face_detection_u55_256.tflite", postprocess=Fomo(threshold=0.4))
print(model)
