# Titan Mini OpenMV example: 内存图像流录放
# Source: ThirdParty/openmv/scripts/examples/01-Camera/01-Video-Recording/imageio_memory.py
# Adaptation: 内存录制由 500 帧降为 20 帧，120×120 RGB565 约 563 KiB，适配本项目内存。
