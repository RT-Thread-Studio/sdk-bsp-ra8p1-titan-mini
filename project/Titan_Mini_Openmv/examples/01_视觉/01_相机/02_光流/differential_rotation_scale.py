# Titan Mini OpenMV example: 差分旋转与缩放光流
# Source: ThirdParty/openmv/scripts/examples/01-Camera/02-Optical-Flow/differential_rotation_scale.py
...
csi0.window((64, 64))  # MIPI capture crop; power-of-two FFT input.
