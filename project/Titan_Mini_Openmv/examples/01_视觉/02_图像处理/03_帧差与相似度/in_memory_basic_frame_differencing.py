# Titan Mini OpenMV example: 内存固定背景帧差
# Source: ThirdParty/openmv/scripts/examples/02-Image-Processing/03-Frame-Differencing/in_memory_basic_frame_differencing.py
