# Titan Mini OpenMV example: 内存动态背景帧差
# Source: ThirdParty/openmv/scripts/examples/02-Image-Processing/03-Frame-Differencing/in_memory_advanced_frame_differencing.py
