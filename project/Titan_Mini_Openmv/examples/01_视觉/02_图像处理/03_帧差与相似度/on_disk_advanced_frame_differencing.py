# Titan Mini OpenMV example: 磁盘动态背景帧差
# Source: ThirdParty/openmv/scripts/examples/02-Image-Processing/03-Frame-Differencing/on_disk_advanced_frame_differencing.py
