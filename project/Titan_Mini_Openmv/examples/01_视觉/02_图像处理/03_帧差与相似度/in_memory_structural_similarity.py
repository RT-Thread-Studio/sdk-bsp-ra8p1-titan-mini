# Titan Mini OpenMV example: 内存结构相似度
# Source: ThirdParty/openmv/scripts/examples/02-Image-Processing/03-Frame-Differencing/in_memory_structural_similarity.py
