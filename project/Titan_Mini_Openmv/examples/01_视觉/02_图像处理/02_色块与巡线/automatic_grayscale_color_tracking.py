# Titan Mini OpenMV example: 自动灰度阈值跟踪
# Source: ThirdParty/openmv/scripts/examples/02-Image-Processing/02-Color-Tracking/automatic_grayscale_color_tracking.py
