# Titan Mini OpenMV example: 透明度表与调色板组合
# Source: ThirdParty/openmv/scripts/examples/02-Image-Processing/00-Drawing/image_drawing_alpha_table_with_color_table_test.py
