# Titan Mini OpenMV example: 调色板与透明度混合
# Source: ThirdParty/openmv/scripts/examples/02-Image-Processing/00-Drawing/image_drawing_alpha_blending_with_color_table_test.py
