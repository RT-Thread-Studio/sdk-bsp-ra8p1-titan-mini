# Titan Mini OpenMV example: 色块预筛选小AprilTag识别
# Source: ThirdParty/openmv/scripts/examples/06-April-Tags/find_small_apriltags.py
# Adaptation: 补齐 QVGA 设置；保留 ROI 上限并移除吞掉 MemoryError 的处理，使实际错误可见。
...
while True:
    ...
    for blob in img.find_blobs(
        ...
        # Bound each search ROI instead of hiding a failed allocation.
