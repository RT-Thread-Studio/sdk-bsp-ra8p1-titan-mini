# Titan Mini OpenMV example: AprilTag三维位姿
# Source: ThirdParty/openmv/scripts/examples/06-April-Tags/find_apriltags_3d_pose.py
# Adaptation: 明确上游 OV7725 镜头内参仅为演示值，保留位姿属性访问和六自由度 print 输出。
...
# Replace these illustrative upstream intrinsics with your OV5640 lens calibration.
# They are NOT a calibration of the Titan Mini camera.
